...
import ATSArch from "@/assets/projects/content/ats/ATS Arch.svg";
import OneLokiArch from "@/assets/projects/content/oneloki/OneLoki Arch.svg";
import DocUArch from "@/assets/projects/content/doc-u/Docu Arch.svg";
import NeoRadioArch from "@/assets/projects/content/neo-radio/Radio Arch.svg";
import MediaArch from "@/assets/projects/content/media-stream/Arch.svg";
...
export const projects = [
  {
    ...
    backgroundImage: TP1,
    about:
      "Built a live quiz platform with leaderboards, real-time scoring, and massive concurrency support.",
    year: "2025",
    duration: "2 Months",
    stack: [
      "Microservices",
  ...
  },
  {
    ...
    about:
      "The solution was designed to analyze NBFC financial documents to detect discrepancies between the original and the scanned version and provide a diff view of the changes in the document.",
    year: "2023",
    duration: "3 Months",
    stack: ["Python", "NLTK", "Flask", "Docker", "AWS"],
    vision:
      "Design a text-difference engine to analyze NBFC financial documents with user authentication",
  ...
  },
  {
    ...
    about:
      "Built a centralized inventory system for managing stock across multiple retail sites with sync support.",
    year: "2023",
    duration: "2 Months",
    stack: ["Python", "Flask", "PostgreSQL", "Docker", "AWS"],
    vision:
      "To simplify inventory visibility and real-time sync across warehouses.",
    role: "Lead Developer & Solution Architect",
    highlights: [
  ...
  },
  {
    ...
    href: "/ats",
    about:
      "Designed and deployed a centralized recruitment and evaluation platform for L&T’s talent teams.",
    year: "2023",
    duration: "4 Months",
    stack: [
      "Node.js",
  ...
  },
  {
    ...
    href: "/oneloki",
    about:
      "Created a Gen AI App Development Platform supporting agents, custom RAGs, low-code workflows, and API deployments, adopted by 12+ enterprise clients from India's 15 largest companies like HDBFS, Reliance, and SBI.",
    year: "2024",
    duration: "5 Months",
    stack: [
      "Python",
    ...
    impact:
      "Solutions impacted over 200,000 active users across multiple organizations (HDBFS, JFSL, ZingHr).",
    lesson:
  ...
  },
  {
    ...
    vision:
      "To create a plug-and-play parsing platform for enterprises to automate document workflows.",
    role: "Lead Developer",
    highlights: [
    ...
    impact:
      "Reduced document processing cost by 80% for pilot users in HR and legal compared to existing solutions like RChilli.",
    lesson:
  ...
  },
  {
    ...
    href: "/media-stream",
    about:
      "Developed a lightweight media server to handle video/image processing, transcoding, and CDN integration for in house use.",
    year: "2023",
    duration: "1 Month",
    stack: ["Node.js", "FFmpeg", "Docker"],
    vision:
      "To offer an internal scalable media backend service for at home network devices.",
    ...
    impact:
      "Reduced media handling latency by 60% and improved asset optimization.",
    lesson:
...
export const labs = [
  {
    ...
    vision:
      "To modernize school libraries by providing a seamless digital platform that fosters reading habits and streamlines library operations.",
    role: "Core Developer",
    highlights: [
    ...
    lesson:
      "Prioritizing user experience and feedback loops is crucial for adoption in educational tools.",
    referenceImages: [],
  },
  {
    name: "SMART HOME",
    ...
    vision:
      "To enhance home automation in my college room and make it more efficient.",
    ...
    impact:
      "Achieved a 60% reduction in manual operations for users, enhancing convenience and energy efficiency.",
    lesson:
      "Need to make solutions idiot proof don't take common sense for granted.",
    referenceImages: [],
  },
  {
    name: "ATHENEUM",
    ...
    vision:
      "To revolutionize online education by making learning more accessible and tailored to individual needs",
    ...
    impact:
      "Placed 7th in the Innovative Product Prototype International Challenge.",
  ...
  },
  {
    ...
    vision:
      "To automate attendance and achieve additional hours to work on my own projects.",
    role: "Sole Developer",
    highlights: [
    ...
    lesson:
      "Cloud is a very expensive future and it should be used with proper optimization and monitoring.",
    referenceImages: [],
  },
  {
    ...
    vision:
      "To create a cost-effective and scalable solution for storing and retrieving large volumes of data.",
    role: "Sole Developer",
    highlights: [
  ...
  },
  {
    ...
    vision:
      "To automate email processing and improve efficiency in a corporate environment.",
    role: "Sole Engineer, Solution Architect",
    highlights: ["Utilized spaCy for entity recognition and data extraction."],
  ...
  },
  {
    ...
    vision:
      "To simplify online payment processes, making them accessible and reliable for businesses of all sizes.",
    ...
    lesson:
      "A well-integrated payment system enhances user trust and business credibility.",
    referenceImages: [],
  },
  {
    ...
    vision:
      "To enhance software quality through rigorous and automated testing processes.",
    role: "Freelancer",
    highlights: [
    ...
    impact:
      "Reduced bug-related incidents by 60% and accelerated deployment cycles by 30%.",
    lesson:
      "Early and continuous testing is vital for maintaining high-quality software products.",
    referenceImages: [],
  },
  {
    name: "GITHUB ACTIONS",
    ...
    vision:
      "To streamline development workflows, reducing manual interventions and errors.",
    role: "Freelancer",
    highlights: [
    ...
    impact:
      "Improved deployment frequency by 40% and reduced integration issues by 50%.",
    lesson:
      "Automating repetitive tasks allows developers to focus more on feature development and innovation.",
    referenceImages: [],
  },
  {
    name: "UI PROPS",
    ...
    vision:
      "To create intuitive and visually appealing interfaces that cater to diverse user needs.",
    role: "Freelancer",
    highlights: [
    ...
    impact:
      "Increased user satisfaction scores by 20% and reduced bounce rates by 15%.",
    lesson:
      "Attention to UI details significantly influences user engagement and retention.",
    referenceImages: [],
  },
];
